      ...
      <div className={css.portfolio__container}>
        ...
        <li className={css.portfolio__item}>
          <div className={css.portfolio__wrap}>
            <img src={webstudio} className={css.img__fluid}
              alt="Web Studio"
              width={260}
              height={240} />
            <div className={css.portfolio__info}>
              ...
              <div className={css.portfolio__links}>
                <a href="https://dimapashchenko1.github.io/goit-markup-hw-08/" className={css.portfolio__link}>Web Studio</a>
              </div>
            </div>
          </div>
        </li>
        ...
        <li className={css.portfolio__item}>
          <div className={css.portfolio__wrap}>
            <img src={hellen} className={css.img__fluid}
              alt="Hellen"
              width={260}
              height={240}  />
            <div className={css.portfolio__info}>
              {/* <h4>Hellen</h4> */}
              <div className={css.portfolio__links}>
                <a href="https://sepaev.github.io/reacteam-project" className={css.portfolio__link}>Hellen</a>
              </div>
            </div>
          </div>
        </li>
        ...
        <li className={css.portfolio__item}>
          <div className={css.portfolio__wrap}>
            <img src={filmoteka} className={css.img__fluid}
              alt="Filmoteka"
              width={260}
              height={240}  />
            <div className={css.portfolio__info}>
              {/* <h4>Filmoteka</h4> */}
              <div className={css.portfolio__links}>
                <a href="https://sepaev.github.io/filmoteka/" className={css.portfolio__link}>Filmoteka</a>
              </div>
            </div>
          </div>
        </li>
        ...
        <li className={css.portfolio__item}>
          <div className={css.portfolio__wrap}>
            <img src={kapusta} className={css.img__fluid}
              alt="Kapusta"
              width={260}
              height={240}  />
            <div className={css.portfolio__info}>
              {/* <h4>Kapusta</h4> */}
              <div className={css.portfolio__links}>
                <a href="https://pedantic-engelbart-4b98e1.netlify.app/" className={css.portfolio__link}>Kapusta</a>
              </div>
            </div>
          </div>
        </li>
